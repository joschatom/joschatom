...
const CACHE_NAME = "Element Konstruktor-cache";
const OFFLINE_URL = "Element Konstruktor.offline.html";
// Files that will be cached on load.
const CACHED_FILES = ["Element Konstruktor.html","Element Konstruktor.js","Element Konstruktor.wasm","Element Konstruktor.pck","Element Konstruktor.offline.html","Element Konstruktor.icon.png","Element Konstruktor.apple-touch-icon.png"];
